      ...
      <div className="about-me">
           <Grid>
             <Cell className="about-me-leftcol" col={4}>
                 ...
                 <img src={photo} style = {{top:'10%',height:'200px',border:'3px solid white',width:'200px',borderRadius:'50%'}} />
                 </div>
                 <h3 style={{paddingTop:'0.5em',textAlign:'center'}}>Vishesh Tiwari</h3>
                 <h4 style={{color:'gray',textAlign:'center'}}>Student,Fresher,Explorer</h4>
